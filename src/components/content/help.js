...
export default function () {
  return (
    <>
      <Typography variant={'h3'}>¿Qué es Tegger?</Typography>
      ...
      <Typography variant={'h3'}>¿Cuál es el objetivo de Tegger?</Typography>
      <Typography variant={'body1'} component="p">
      ...
      <Typography variant={'h3'}>¿Cómo funciona Tegger?</Typography>
      <Typography variant={'body1'} component="p">
      ...
      <Typography variant={'h3'}>¿Cómo garantiza Tegger la seguridad de mis datos?</Typography>
      <Typography variant={'body1'} component="p">
      ...
      <Typography variant={'h3'}>¿Qué hará Tegger con mis datos?</Typography>
      ...
      <Typography variant={'h3'}>¿A quién puede beneficiar Tegger y cómo?</Typography>
      <Typography variant={'body1'}>
      ...
      <Typography variant={'h3'}>¿Cómo puedo limitar los datos que decido compartir?</Typography>
      <Typography variant={'body1'}>
      ...
      <Typography variant={'h3'}>¿Qué gano por compartir mis datos?</Typography>
      <Typography variant={'body1'}>
